...
func init() {
	...
	beego.Router("/bol-admin/update/post/:post_id", &controllers.AdminController{}, "put:UpdatePost")
	beego.Router("/bol-admin/add/image", &controllers.AdminController{}, "post:AddImage")
	beego.Router("/bol-admin/update/image/:image_id", &controllers.AdminController{}, "put:UpdateImage")
